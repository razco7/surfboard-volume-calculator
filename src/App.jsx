...
const TR = {
  en: {
    ...
    langEn:            "English",
    langHe:            "Hebrew",
    footer:            "Based on the Guild Factor formula by John \"Whitney\" Guild & industry guidelines.\nVolume is a starting point — conditions and personal preference always win.",
    credit:            "Created by",
    creditClaude:      "Claude",
    creditAnd:         " & ",
    creditRaz:         "Raz Cohen",
  ...
  he: {
    ...
    langEn:            "אנגלית",
    langHe:            "עברית",
    footer:            "מבוסס על נוסחת גורם הגילד מאת ג'ון \"וויטני\" גילד והנחיות התעשייה.\nהנפח הוא נקודת התחלה — תנאים והעדפות אישיות תמיד ינצחו.",
    credit:            "נוצר על ידי",
    creditClaude:      "Claude",
    creditAnd:         " ו-",
    creditRaz:         "רז כהן",
